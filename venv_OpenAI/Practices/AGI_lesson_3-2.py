...
prompt = "我到北京出差，给我推荐亮马桥的酒店，和三里屯附近的咖啡"
prompt = "我去中華人民共和国 北京市 東城区 前門 邮政编码: 100051，告诉我附近有什么景点？另外，有没有公共厕所？"
prompt = "我去中国北京市东城区西长安街观光，告诉我附近有什么景点？另外，有没有公共厕所？"
...
while (response.tool_calls is not None):
    ...
    for tool_call in response.tool_calls:
        ...
        print("=====函数返回 按json格式print(result)=====")
        print_json(result)
